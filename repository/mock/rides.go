...
import (
	...
	backend_coding_test "github.com/hawarir/backend-coding-test"
)
...
func (m *MockRideRepository) Insert(arg0 backend_coding_test.Ride) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRideRepository) SelectAll() ([]backend_coding_test.Ride, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelectAll")
	ret0, _ := ret[0].([]backend_coding_test.Ride)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SelectAll indicates an expected call of SelectAll.
func (mr *MockRideRepositoryMockRecorder) SelectAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelectAll", reflect.TypeOf((*MockRideRepository)(nil).SelectAll))
}

// SelectByID mocks base method.
func (m *MockRideRepository) SelectByID(arg0 int64) (*backend_coding_test.Ride, error) {
	m.ctrl.T.Helper()
